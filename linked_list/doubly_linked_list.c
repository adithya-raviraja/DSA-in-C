...
int getListSizeAndContents(int *size, listGeneric_T *mainList)
{
    ...
    printf("LAST_ENTRY VALUE");
#if 0
    for(singleEntry = lastEntry; singleEntry != NULL; singleEntry = (listGeneric_T *)singleEntry->prev)
    {
